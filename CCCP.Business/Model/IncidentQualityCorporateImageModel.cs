...
{
    public class IncidentQualityCorporateImageModel : IIncidentModel
    {
        #region Constructor

        public IncidentQualityCorporateImageModel()
        {
            init();
        }
        public IncidentQualityCorporateImageModel(IncidentQualityCorporateImage viewModel)
        {
            init();
        ...
        public IncidentQualityCorporateImage Entity = new IncidentQualityCorporateImage();
        ...
        {
            this.Options_PossibleCause = InputOptionsService.GetIncidentQualityCorporateImageInputOptions(IncidentQualityCorporateImageInputKey.IncidentQualityCorporateImage_PossibleCause);
            this.Options_Impact = InputOptionsService.GetIncidentQualityCorporateImageInputOptions(IncidentQualityCorporateImageInputKey.IncidentQualityCorporateImage_Impact);
            this.Options_StatusUpdate = InputOptionsService.GetIncidentQualityCorporateImageInputOptions(IncidentQualityCorporateImageInputKey.IncidentQualityCorporateImage_StatusUpdate);
        }
