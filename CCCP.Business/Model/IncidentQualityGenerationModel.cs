...
{
    public class IncidentQualityGenerationModel : IIncidentModel
    {
        #region Constructor

        public IncidentQualityGenerationModel()
        {
            init();
        }
        public IncidentQualityGenerationModel(IncidentQualityGeneration viewModel)
        {
            init();
        ...
        public IncidentQualityGeneration Entity = new IncidentQualityGeneration();
