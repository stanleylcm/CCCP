...
namespace CCCP.Business.Model
{
    public class IncidentEnvironmentLeakageModel : IIncidentModel
    {
        ...
        public IncidentEnvironmentLeakageModel()
        {
            init();
        }
        public IncidentEnvironmentLeakageModel(IncidentEnvironmentLeakage viewModel)
        {
            init();
        ...
        public List<string> Options_TypeOfLeakage = new List<string>();
        ...
        {
            this.Options_SourceOfInformation = InputOptionsService.GetIncidentEnvironmentLeakageInputOptions(IncidentEnvironmentLeakageInputKey.IncidentEnvironmentLeakage_SourceOfInformation);
            this.Options_TypeOfLeakage = InputOptionsService.GetIncidentEnvironmentLeakageInputOptions(IncidentEnvironmentLeakageInputKey.IncidentEnvironmentLeakage_TypeOfLeakage);
            this.Options_AffectedArea = InputOptionsService.GetIncidentEnvironmentLeakageInputOptions(IncidentEnvironmentLeakageInputKey.IncidentEnvironmentLeakage_AffectedArea);
        }
