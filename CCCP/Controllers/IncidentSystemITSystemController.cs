...
namespace CCCP.Controllers
{
    public class IncidentSystemITSystemController : Controller
    {
        ...
        public ActionResult CreateByEnquiry([Bind(Include = "IncidentSystemITSystemId,ChecklistBatchId,ChatRoomId,GeneralEnquiryId,CrisisIdIssueById,IssueDateTime,CloseById,CloseDateTime,IncidentNo,LevelOfSeverity,IncidentStatus,IncidentBackground,IsDrillMode,Location,PossibleCause,Damage,AffectedSystem,AffectedArea,ExpectedRestorationTime,CreatedBy,CreatedDateTime,LastUpdatedBy,LastUpdatedDateTime")] IncidentSystemITSystem incidentEntity)
        {
        ...
        public ActionResult EscalateToCrisis()
        {
            ...
            int id = new IncidentApiController().EscalateToCrisis(incident.Entity.IncidentSystemITSystemId, MasterTableService.GetIncidentTypeId(IncidentTypeSubType.SystemITSystem));
