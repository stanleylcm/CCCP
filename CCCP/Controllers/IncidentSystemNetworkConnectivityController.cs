...
namespace CCCP.Controllers
{
    public class IncidentSystemNetworkConnectivityController : Controller
    {
        ...
        public ActionResult CreateByEnquiry([Bind(Include = "IncidentSystemNetworkConnectivityId,ChecklistBatchId,ChatRoomId,GeneralEnquiryId,CrisisIdIssueById,IssueDateTime,CloseById,CloseDateTime,IncidentNo,LevelOfSeverity,IncidentStatus,IncidentBackground,IsDrillMode,Location,PossibleCause,Damage,AffectedArea,ExpectedRestorationTime,CreatedBy,CreatedDateTime,LastUpdatedBy,LastUpdatedDateTime")] IncidentSystemNetworkConnectivity incidentEntity)
        {
        ...
        public ActionResult Create([Bind(Include = "IncidentSystemNetworkConnectivityId,ChecklistBatchId,ChatRoomId,GeneralEnquiryId,CrisisIdIssueById,IssueDateTime,CloseById,CloseDateTime,IncidentNo,LevelOfSeverity,IncidentStatus,IncidentBackground,IsDrillMode,Location,PossibleCause,Damage,AffectedArea,ExpectedRestorationTime,CreatedBy,CreatedDateTime,LastUpdatedBy,LastUpdatedDateTime")] IncidentSystemNetworkConnectivity incidentSystemNetworkConnectivity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IncidentSystemNetworkConnectivityId,ChecklistBatchId,ChatRoomId,GeneralEnquiryId,CrisisIdIssueById,IssueDateTime,CloseById,CloseDateTime,IncidentNo,LevelOfSeverity,IncidentStatus,IncidentBackground,IsDrillMode,History,Location,PossibleCause,Damage,AffectedArea,ExpectedRestorationTime,FullRestoration,CreatedBy,CreatedDateTime,LastUpdatedBy,LastUpdatedDateTime")] IncidentSystemNetworkConnectivity incidentSystemNetworkConnectivity)
        {
        ...
        public ActionResult LinkIncident(string incidentId, string incidentTypeId, string linkList)
        {
            ...
            IncidentSystemNetworkConnectivity incidentSystemNetworkConnectivity = db.IncidentSystemNetworkConnectivity.Find(Convert.ToInt32(incidentId));

            return Json(new { SelectedIncidentNo = incidentSystemNetworkConnectivity.IncidentNo });
        }
