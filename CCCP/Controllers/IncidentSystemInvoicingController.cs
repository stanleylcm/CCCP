...
namespace CCCP.Controllers
{
    public class IncidentSystemInvoicingController : Controller
    {
        ...
        public ActionResult LinkIncident(string incidentId, string incidentTypeId, string linkList)
        {
            ...
            IncidentSystemInvoicing incidentSystemInvoicing = db.IncidentSystemInvoicing.Find(Convert.ToInt32(incidentId));

            return Json(new { SelectedIncidentNo = incidentSystemInvoicing.IncidentNo });
        }
