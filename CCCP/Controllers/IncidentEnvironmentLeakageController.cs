...
namespace CCCP.Controllers
{
    public class IncidentEnvironmentLeakageController : Controller
    {
        ...
        public ActionResult LinkIncident(string incidentId, string incidentTypeId, string linkList)
        {
            ...
            IncidentEnvironmentLeakage incidentEnvironmentLeakage = db.IncidentEnvironmentLeakage.Find(Convert.ToInt32(incidentId));

            return Json(new { SelectedIncidentNo = incidentEnvironmentLeakage.IncidentNo });
        }
